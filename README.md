...
- `git switch -`: Te lleva a la rama en la que estuviste anteriormente
...
- `git reset --hard origin/[rama]`: resetea el estado de la rama a como está en el puntero del HEAD de la rama origin. Util cuando un compañero hizo rebase
